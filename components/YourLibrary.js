...
const CategorySection = () => {
  const categories = [
    ...
    },
    {
      name: 'Downloads',
      count: '210 songs',
      icon: require('../assets/download-for-offline.png'),
    },
    {
      name: 'Playlists',
      count: '12 playlists',
      icon: require('../assets/queue-music.png'),
    },
    {
      name: 'Artists',
      count: '3 artists',
      icon: require('../assets/mdi-account-music-outline.png'),
    },
  ];
  ...
  return (
    <View style={categorySectionStyles.container}>
      {categories.map((category, index) => (
        <TouchableOpacity key={index} style={categorySectionStyles.categoryContainer}>
          <Image source={category.icon} style={categorySectionStyles.icon} />
